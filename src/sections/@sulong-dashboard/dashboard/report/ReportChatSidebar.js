...
//
import ReportChatAccount from './ReportChatAccount';
import ReportChatSearchResults from './ReportChatSearchResults';
import ReportChatContactSearch from './ReportChatContactSearch';
import ReportChatConversationList from './ReportChatConversationList';
...
export default function ReportChatSidebar() {
    ...
    <>
      ...
      <Scrollbar>
        {!displayResults ? (
          ...
          <ReportChatSearchResults query={searchQuery} results={searchResults} onSelectContact={handleSelectContact} />
        )}
      </Scrollbar>
    </>
  );
