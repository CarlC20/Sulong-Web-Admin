...
//
import ReportChatConversationItem from './ReportChatConversationItem';

// ----------------------------------------------------------------------

ReportChatConversationList.propTypes = {
...
export default function ReportChatConversationList({
  conversations,
  isOpenSidebar,
  ...
  const handleSelectConversation = (conversationId) => {
    ...
    navigate(`${PATH_DASHBOARD.incidentReports.root}/chat/${conversationKey}`);
  };
