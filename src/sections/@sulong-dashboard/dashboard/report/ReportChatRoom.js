...
//
import ReportChatRoomAttachment from './ReportChatRoomAttachment';
import ReportChatRoomOneParticipant from './ReportChatRoomOneParticipant';
import ReportChatRoomGroupParticipant from './ReportChatRoomGroupParticipant';
...
ReportChatRoom.propTypes = {
  conversation: PropTypes.object.isRequired,
  participants: PropTypes.array.isRequired,
};

export default function ReportChatRoom({ conversation, participants }) {
  ...
  const renderContent = (
    <>
      {isGroup ? (
        <ReportChatRoomGroupParticipant
