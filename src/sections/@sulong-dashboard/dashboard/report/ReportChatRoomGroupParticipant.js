...
//
import ReportChatRoomPopup from './ReportChatRoomPopup';
...
ReportChatRoomGroupParticipant.propTypes = {
...
export default function ReportChatRoomGroupParticipant({
  participants,
  selectUserId,
  onShowPopupUserInfo,
  isCollapse,
...
function Participant({ participant, isOpen, onClosePopup, onShowPopup }) {
  ...
  return (
    <>
      ...
      <ReportChatRoomPopup participant={participant} isOpen={isOpen} onClose={onClosePopup} />
    </>
  );
}
