...
export const _notifications = [...Array(5)].map((_, index) => ({
  id: _mock.id(index),
  title: ['Carl Castillano', 'Sylvan King', 'Jerald Lanuza', 'Maycha Jamera', 'Gabriel Domingo'][index],
  description: [
    'reported a robbing incident',
    'requested for barangay id',
    'reservation for basketball court',
    'reservation for barangay hall',
    'requested for travel pass',
  ][index],
